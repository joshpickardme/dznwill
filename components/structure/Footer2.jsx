    ...
    return (
        <footer className="flex flex-col gap-6 md:gap-0 md:flex-row min-h-[165px] items-center justify-between bg-[var(--turquoise)] -ml-6 -mr-6 lg:-ml-16 lg:-mr-16 md:-ml-8 md:-mr-8 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
            ...
            <div className="flex flex-row md:hidden gap-2 pb-6">
                <SocialIcon link={'https://uk.linkedin.com/in/will-cotton-605ba4226'} icon={<FaLinkedinIn className="scale-[1.5] text-[var(--turquoise)]"></FaLinkedinIn>}></SocialIcon>
                <SocialIcon link={'https://twitter.com/DznWill'} icon={<FaTwitter className="scale-[1.5] text-[var(--turquoise)]"></FaTwitter>}></SocialIcon>
                <SocialIcon link={'https://www.instagram.com'} icon={<GrInstagram className="scale-[1.5] text-[var(--turquoise)]"></GrInstagram>}></SocialIcon>
                <SocialIcon link={'mailto:williamcotton340@gmail.com'} icon={<IoMail className="scale-[1.5] text-[var(--turquoise)]"></IoMail>}></SocialIcon>
            </div>
        </footer>
    )
}